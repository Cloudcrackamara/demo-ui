...
const hero = () => {
  return (
    <div className="w-full bg-[#49BBBD] min-h-[700px] md:min-h-[600px] lg:min-h-[700px] flex flex-col md:flex-row items-center justify-between px-6 sm:px-12 lg:px-34 md:px-16 py-12 md:py-0 relative overflow-hidden [clip-path:ellipse(160%_100%_at_50%_0%)] md:[clip-path:ellipse(120%_100%_at_50%_0%)]">
      ...
      <div className="w-full md:w-[55%] flex justify-center items-end relative self-end h-auto mt-auto">
        ...
        <div className="relative w-full max-w-[480px] md:max-w-[550px] lg:max-w-[650px] aspect-[4/3] sm:aspect-[1.15/1] md:aspect-[0.9/1] lg:aspect-[1.1/1] xl:aspect-[1.2/1]">
